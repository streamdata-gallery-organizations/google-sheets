...
- name: Google Sheets
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-sheets/master/_listings/google-sheets/spreadsheets-spreadsheetid-getbydatafilter-post.md
x-common:
